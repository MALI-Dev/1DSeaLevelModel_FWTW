...
module sl_model_mod
   ...
   type(sh_transform) :: spheredat                             ! SH transform data to be passed to subroutines
...
!   integer :: nmelt, nfiles, iter, itersl, dtime           ! Number of melting episodes up to the current timestep
   ...
   subroutine sl_solver_checkpoint(itersl, dtime)
      ...
      call sh_init(spheredat, 2*nglv, nglv, norder, radius) ! Initialize spheredat (for SH transform subroutines)
